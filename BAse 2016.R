...
table(HogaresIndigenas$HogarIndigena)

HogaresIndigenas[is.na(HogaresIndigenas)]<-0
...
Deflactores2016<-data.frame(entidad,entidades,Deflactores)

Conc<-merge(Conc,Deflactores2016,by=c("entidad"))
...
names(Conc2016)<-toupper(names(Conc2016))


mydesign <- svydesign(id=~UPM,strata=~EST_DIS,data=Conc2016,weights=~FACTOR_HOG)
...
names(c_DECIL_ES)=c("ING COR2016", "TRABAJO2016", "SUBORDINADO2016", "NEGOCIOS2016","OTROS TRAB2016", "RENTAS2016","UTILIDAD2016", "ARRENDA2016", "TRANSFER2016","JUBILACION2016", "BECAS2016", "DONATIVOS2016", "REMESAS2016", "BENEGOBIERNO2016", "TRANS HOG2016", "TRANS INST2016", "ESTIM ALQU2016", "OTROS INGRESOS2016")

names(c_DECIL_SE)=c("ING COR2016", "TRABAJO2016", "SUBORDINADO2016", "NEGOCIOS2016","OTROS TRAB2016", "RENTAS2016","UTILIDAD2016", "ARRENDA2016", "TRANSFER2016","JUBILACION2016", "BECAS2016", "DONATIVOS2016", "REMESAS2016", "BENEGOBIERNO2016", "TRANS HOG2016", "TRANS INST2016", "ESTIM ALQU2016", "OTROS INGRESOS2016")

names(c_DECIL_CV)=c("ING COR2016", "TRABAJO2016", "SUBORDINADO2016", "NEGOCIOS2016","OTROS TRAB2016", "RENTAS2016","UTILIDAD2016", "ARRENDA2016", "TRANSFER2016","JUBILACION2016", "BECAS2016", "DONATIVOS2016", "REMESAS2016", "BENEGOBIERNO2016", "TRANS HOG2016", "TRANS INST2016", "ESTIM ALQU2016", "OTROS INGRESOS2016")

names(c_DECIL_LI)=c("ING COR2016", "TRABAJO2016", "SUBORDINADO2016", "NEGOCIOS2016","OTROS TRAB2016", "RENTAS2016","UTILIDAD2016", "ARRENDA2016", "TRANSFER2016","JUBILACION2016", "BECAS2016", "DONATIVOS2016", "REMESAS2016", "BENEGOBIERNO2016", "TRANS HOG2016", "TRANS INST2016", "ESTIM ALQU2016", "OTROS INGRESOS2016")
...
prueba<-c_DECIL_ES%>%
  mutate(`ING COR2016`=`ING COR2016`, prueba=TRABAJO2016+RENTAS2016+JUBILACION2016+BECAS2016+DONATIVOS2016+REMESAS2016+BENEGOBIERNO2016+`TRANS HOG2016`+`TRANS INST2016`+`ESTIM ALQU2016`+`OTROS INGRESOS2016`)

all.equal(prueba$`ING COR2016`,prueba$prueba)
...
write.dbf(Consumo_SE,file="Nacional Consumo  por DECIL 2016 SE.dbf")
...
write.dbf(c_DECIL_LI,file = "Nacional por fuente por DECIL LI 2016.dbf")
...
names(Conc2016)<-c("ENTIDAD","FOLIOVIV","FOLIOHOG","GASTO","TOT_INTEG","ING_COR","INGTRAB","TRABAJO","NEGOCIO",
...
write.dbf(bottom_por_ingresos,file = "bottom_por_ingresos_2016.dbf")
...
write.dbf(Consumo,file = "Consumo_por_bottom_2016.dbf")
